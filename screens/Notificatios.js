    ...
    return (
      <ScrollView showsVerticalScrollIndicator={false}>
        <Container>
          ...
          <RecipeBackground source={Images.notifications}>
            <SafeAreaView>
              <MainRecipe>
                <TextT title heavy>
                  Notifications
                ...
                <Divider />
                <TextT address bold>
                  {`Recieved notifications by options`}
                </TextT>
              </MainRecipe>
            </SafeAreaView>
          </RecipeBackground>
            ...
            <Recipes>
              <Block style={styles.toggles}>
                ...
                {notification ? (
                  <TextT
                    bold
                    style={{color: '#BD2031', marginTop: -50 * scale}}>
                    Long press on member will notify you when the member wrote a
                    advice.
                  </TextT>
                ) : null}

                {notification ? this.showContactsMember() : null}
              </Block>
            </Recipes>
          </RecipesContainer>
        </Container>
